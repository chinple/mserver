...
class HttpClient:
    ...
    def sendRequest(self, path="/", body=None, command="GET", isReadResp=True, headers=None):
...
def curl(url, body=None, isReadResp=True, logHandler=None, logHeader=False, logResp=False, connTimeout=None, command=None, client=None, **headers):
